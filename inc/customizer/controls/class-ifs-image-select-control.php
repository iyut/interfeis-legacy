...
class IFS_Image_Select_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'ifs-legacy-adm-image-select-control', get_template_directory_uri() . '/inc/customizer/js/control-image-select.js', array( 'jquery' ), false, true );
		wp_enqueue_style( 'ifs-legacy-adm-image-select', get_template_directory_uri() . '/inc/customizer/css/image-select.css' );
	}
