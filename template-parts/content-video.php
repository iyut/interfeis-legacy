...
<article id="post-<?php the_ID(); ?>" <?php post_class('ifs-post-format-video'); ?>>

	<div class="entry-media">
		<?php 
		$vid_url 	= get_post_meta( get_the_ID(), 'ifs_video_url', true );
		if($vid_url != ''){
			echo apply_filters('the_content', $vid_url);
		}
		?>
	</div>
